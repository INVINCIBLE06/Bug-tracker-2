...
module.exports = function(app)
{
    ...
    app.put('bugtracker/api/check/security/:email', verifyparams.VerifyEmailForSecurityAnswerOnPathParams, passwordvalidation, usercontroller.UpdatePasswordOnTheBasisOfEmailInParams);
    ...
    app.get('bugtracker/api/get/all/user/not/logged/one/:id', verifyparams.UserIdIsCorrectInParams, usercontroller.GetAllUserWithOutTheLoggedOne);
