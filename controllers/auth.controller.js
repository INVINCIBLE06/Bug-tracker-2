                    ...
                    con.query(MidName, async (err, resultMID) => // executing the above query  
                    {
                        ...
                        else
                        {
                            ...
                            if(result2) // If it is correct then it will inside the if loop
                                {
                                    let updateBecauseNowCorrectPasswordIsEntered = await commonoperation.updateStatusaftercorrectpasswordentered(result[0].User_Id)
                                    if(updateBecauseNowCorrectPasswordIsEntered)
                                    {
