...
module.exports = function(app)
{
     ...
     */
    app.post('bugtracker/api/add/new/user', tokenVerification.IsAdminTokenVerification, emailvalidation, passwordvalidation, contactvalidation, birthdateValidation, duplicatecheck.duplicateValueEmail, duplicatecheck.duplicateValueMobile, authcontroller.AddNewUser);
    /**
     * below route will be used to signin the user
     * email and password will be validated and then it will be able to signin
     */
    app.post('bugtracker/api/login/exist/user', emailvalidation, authcontroller.signin);
    /**
     * below route will be used to signin the user
     * email and password will be validated and then it will be able to signin
     */
    app.post('bugtracker/api/logout/exist/user/:id', verifyparams.UserIdIsCorrectInParams, authcontroller.SignOut);

    // The below route is for logout of a user. Based on a userId
    app.get('bugtracker/api/user/activity/log/:id', verifyparams.UserIdIsCorrectInParams, authcontroller.activitylogs);
